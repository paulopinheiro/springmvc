...
public class DemoAspect {
    ...
    /**
     * This is pointcut for all methods execution in the package
     * com.itbulls.learnit.spring.aop
     */
    @Pointcut("execution(* br.com.paulopinheiro.springmvc.aop.*.*(..))")
...
//		joinPoint.proceed(new Object[] {"param1", "param2"});
        return retVal;
    }
}
