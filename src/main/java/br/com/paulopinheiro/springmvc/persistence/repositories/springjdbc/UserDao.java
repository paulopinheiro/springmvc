...
public class UserDao {
    ...
    public int addSampleUser() {
        return jdbcTemplate.update("INSERT INTO users (firstname, lastname, enabled) VALUES (?, ?, ?)", "John", "Doe", 1);
    }

    public String getLastNameOfUserById(Integer id) {
        SqlParameterSource namedParameters = new MapSqlParameterSource().addValue("id", id);
        return namedParameterJdbcTemplate.queryForObject("SELECT lastname FROM users WHERE ID = :id", namedParameters, String.class);
    }
